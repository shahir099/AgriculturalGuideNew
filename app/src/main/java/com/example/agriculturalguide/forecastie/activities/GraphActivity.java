...
public class GraphActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView temperatureTextView =(TextView) findViewById(R.id.graphTemperatureTextView);
        TextView rainTextView =(TextView) findViewById(R.id.graphRainTextView);
        TextView pressureTextView =(TextView) findViewById(R.id.graphPressureTextView);
        TextView windSpeedTextView =(TextView) findViewById(R.id.graphWindSpeedTextView);
